...
// Fungsi login dengan parameter pointer
bool login(string *nama, string *nim) {
    return *nama == "rasyid" && *nim == "042";
}

// Fungsi untuk menampilkan data dengan pointer
...
// Fungsi untuk menambah data dengan pointer
...
// Fungsi untuk mengubah data dengan pointer
...
// Fungsi untuk menghapus data dengan pointer
...
// Fungsi dengan parameter address-of (menggunakan &)
...
int main() {
    ...
    for (int percobaan = 1; percobaan <= maksimalpercobaan; percobaan++) {
        ...
        // Menggunakan address-of operator (&) untuk mendapatkan alamat variabel
